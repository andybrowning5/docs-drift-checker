...
var SYSTEM_PROMPT = `You are a documentation drift checker. You analyze codebases to find where documentation has fallen out of sync with the actual code.
